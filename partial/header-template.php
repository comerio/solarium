        ...
        <div class="container-header container">
            <div class="row">
                <div class="col-lg-2 col-md-10 col-xs-10 col-sm-10 col-8 logo-wrapper d-sm-none">
                    <h1>
                        <a href="<?php echo home_url(); ?>">
                            <img src="<?php echo esc_url( get_stylesheet_directory_uri()); ?>/build/img/logo-eu-dou-conta-mobile.png" alt="Logo" class="logo">
                        </a>
                    </h1>
                </div>
                ...
                <div class="col-lg-2 col-md-10 col-xs-10 col-sm-10 col-8 logo-wrapper d-none d-sm-block">
                    <h1>
                        <a href="<?php echo home_url(); ?>">
                            <img src="<?php echo esc_url( get_stylesheet_directory_uri()); ?>/build/img/logo-eu-dou-conta-topo.png" alt="Logo" class="logo">
                        </a>
                    </h1>
                </div>
